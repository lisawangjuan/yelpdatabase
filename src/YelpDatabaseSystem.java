...
public class YelpDatabaseSystem extends JFrame {
     ...
     */
    public YelpDatabaseSystem() {
        initComponents();
        try {
            init();
        } catch (SQLException ex) {
            Logger.getLogger(YelpDatabaseSystem.class.getName()).log(Level.SEVERE, null, ex);
...
//            }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YelpDatabaseSystem().setVisible(true);
            }
        });
    }
